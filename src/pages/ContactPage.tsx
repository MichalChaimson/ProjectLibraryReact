...
const ContactForm: React.FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    // TODO: Submit the form data to your server or API
    setSubmitted(true);
  };
  ...
  return (
    <div style={{ width: '100%', display: 'flex', justifyContent: 'center', paddingTop: '3%' }}>
      {sumbmitted? (
        <b style={{ textAlign: 'center',fontSize: '100px' }}>ההודעה נשלחה בהצלחה!</b>
        ) : (
      <form onSubmit={handleSubmit} style={{ width: '70%', maxWidth: '500px', marginTop: '20px' }}>
